<!-- Ce composant est chargé de gerer les posts-->
<template>
  <router-view>
      ...
      >
        <div class="form">
          <form v-on:submit.prevent>
            ...
            <label for="image">Et c'est parti👇</label>
          ...
          <div>
            ...
            >
              <div class="d-flex flex-row align-items-center px-2">
                <router-link
                  :to="{ name: 'MyUser', params: { userId: post.authorId } }"
                >
                  <img
          ...
          <div class="block-com disp">
            ...
            >
              <div class="pp" v-if="post.postId === comment.postId">
                <router-link
                  :to="{ name: 'MyUser', params: { userId: comment.authorId } }"
                >
                  <img
