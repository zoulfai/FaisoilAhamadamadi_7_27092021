<!-- Le composant App est responsable du rendu dynamique de nos composants -->
<template>
  <header>
      ...
      >
        ...
        <ul class="nav justify-content-center">
          <li class="nav-item" v-if="user">
            <a class="nav-link">
              <router-link
                :to="{ name: 'MyUser', params: { userId: user.id } }"
              >
                <img
                  v-bind:src="user.pp"
                  alt="pp"
        ...
        <form class="form-inline my-2 my-lg-0 displaysearch" v-if="user">
          ...
          <div class="results" v-if="userSearch && research != ''">
            <div v-for="result in userSearch" :key="result.id" class="result">
              <router-link
                :to="{ name: 'MyUser', params: { userId: result.id } }"
              >
                <img
                  class="imgSearch"
